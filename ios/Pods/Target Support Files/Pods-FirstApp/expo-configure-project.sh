...
with_node \
  ...
  --target "/Users/joieambrose/FirstApp/ios/Pods/Target Support Files/Pods-FirstApp/ExpoModulesProvider.swift" \
  --entitlement "/Users/joieambrose/FirstApp/ios/FirstApp/FirstApp.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-camera" "expo-constants" "expo-file-system" "expo-font" "expo-gl" "expo-haptics" "expo-keep-awake" "expo-location"
